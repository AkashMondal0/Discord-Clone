...
interface EditChannelModelProps { }
const EditChannelModel: FC<EditChannelModelProps> = () => {
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select disabled={isLoading} onValueChange={field.onChange} defaultValue={field.value}>
                                            <FormControl>
                                                <SelectTrigger className='bg-zinc-300/50 border-0 capitalize outline-none
                                            ...
                                            <SelectContent>
                                                {Object.values(ChannelType).map((type) => (
                                                    <SelectItem className='capitalize' value={type} key={type}>{type.toLocaleLowerCase()}</SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
